        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            (i.style.position = "absolute"),
              ...
              (i.style.fontSize = window.getComputedStyle(e).fontSize),
              (i.style.fontFamily = window.getComputedStyle(e).fontFamily),
              (i.textContent = t),
        ...
        (i = [
          {
            ...
            value: function () {
              if (this.$ele) {
                var e = this.uniqueId,
                  t = "vscomp-wrapper",
                  i = this.showValueAsTags
                    ? ""
                    : this.getTooltipAttrText(this.placeholder, !0, !0),
                  ...
                  n = this.ariaLabelText
                    ...
                    : "",
                  r = this.ariaLabelClearButtonText
                    ? 'aria-label="'.concat(this.ariaLabelClearButtonText, '"')
                    : "",
                  a = !1;
                ...
                var l = '<div id="vscomp-ele-wrapper-'
                ...
                (this.$ele.innerHTML = l),
                  ...
                  this.hasDropboxWrapper
                    ? ((this.$allWrappers = [
                      ...
                      p.addClass(this.$dropboxContainer, "pop-comp-wrapper"))
            ...
            value: function (e) {
              ...
              if (i) {
                ...
                return (
                  ...
                  (s.innerHTML = o),
                  i.appendChild(s),
                  p.addClass(s, "vscomp-dropbox-wrapper ".concat(t)),
                  ""
                );
              }
            ...
            value: function () {
              ...
              o.forEach(function (o) {
                var s,
                  ...
                  E = "";
                if (
                  (o.classNames && (y += " ".concat(o.classNames)),
                  o.isFocused && ((w = "0"), (y += " focused")),
                  o.isDisabled &&
                    ((y += " disabled"), (E = 'aria-disabled="true"')),
                  o.isGroupTitle &&
                    ((v = o.label), (y += " group-title"), u && (m = "")),
                  k && (y += " selected"),
                  o.isGroupOption)
                ) {
                  var C = "";
                  (y += " group-option"),
                    (S = 'data-group-index="'.concat(o.groupIndex, '"')),
                    o.customData
                      ? ((v =
                          void 0 !== o.customData.group_name
                            ? "".concat(o.customData.group_name, ", ")
                            : ""),
                        (C =
                          void 0 !== o.customData.description
                ...
                (s = h ? l(o) : o.label),
                  o.description &&
                    (O = '<div class="vscomp-option-description" '
                      .concat(b, ">")
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return document.activeElement === this.$searchInput &&
                e.shiftKey &&
                9 === t
                ? (e.preventDefault(), void this.$dropboxContainerTop.focus())
                : document.activeElement === this.$searchInput && 9 === t
                ? (e.preventDefault(), void this.focusFirstVisibleOption())
                : void (document.activeElement !== this.$wrapper ||
                  (27 !== t && "Escape" !== e.key) ||
                  !this.showAsPopup
                    ? i && this[i](e)
                    : this.closeDropbox());
            ...
            value: function (e) {
              e.preventDefault(),
                this.isOpened()
                  ...
                  : !1 === this.$ele.disabled && this.openDropbox();
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                !p.hasClass(t, "disabled") &&
                (p.hasClass(t, "group-title")
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                this.isOpened() &&
                (p.hasClass(t, "disabled") || p.hasClass(t, "group-title")
          ...
          },
          {
            ...
            value: function () {
              p.addClass(this.$ele, "vscomp-ele"),
                this.renderSearch(),
                this.setEleStyles(),
            ...
            value: function () {
              ...
              if (
                ((!this.allowNewOption ||
                  ...
                  (p.toggleClass(this.$allWrappers, "has-no-search-results", i),
                  i
                    ? (p.setAttr(this.$noSearchResults, "tabindex", "0"),
                      p.setAttr(this.$noSearchResults, "aria-hidden", "false"))
                    : (p.setAttr(this.$noSearchResults, "tabindex", "-1"),
                      p.setAttr(this.$noSearchResults, "aria-hidden", "true"))),
                p.toggleClass(this.$allWrappers, "has-no-options", t),
                t
                  ? (p.setAttr(this.$noOptions, "tabindex", "0"),
                    p.setAttr(this.$noOptions, "aria-hidden", "false"))
                  : (p.setAttr(this.$noOptions, "tabindex", "-1"),
                    p.setAttr(this.$noOptions, "aria-hidden", "true")),
                this.setOptionAttr(),
                this.setOptionsPosition(),
                this.setOptionsTooltip(),
                document.activeElement !== this.$searchInput)
              ) {
                var o = p.getElementsBySelector(
                  ".focused",
                  this.$dropboxContainer
                )[0];
                void 0 !== o && o.focus();
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this.$ele = t.ele),
                ...
                (this.ariaLabelClearButtonText = t.ariaLabelClearButtonText),
            ...
            value: function () {
              ...
              this.allowNewOption &&
                ...
                s
                  ...
                  : this.updatePosition(),
                this.setVisibleOptionsCount(),
                p.removeClass(this.$allWrappers, "server-searching");
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              var t = parseInt(
                (e || this.getVisibleStartIndex()) * this.optionHeight
              );
              (this.$options.style.transform = "translate3d(0, ".concat(
                t,
                "px, 0)"
              )),
                p.setData(this.$options, "top", t);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var a = this.getValue();
              (this.$ele.value = a),
                (this.$hiddenInput.value = this.getInputValue(a)),
                ...
                r || this.validate(),
                o || p.dispatchEvent(this.$ele, "change", !0);
            },
          },
          {
            key: "setValueText",
            value: function () {
              ...
              if (h && this.hideValueTooltipOnSelectAll)
                ...
                this.getSelectedOptions({
                  ...
                  var i = t.label;
                  if ((a.push(i), (c += 1), n)) {
                    var u = s.willTextOverflow(r.parentElement, i)
                        ? e.getTooltipAttrText(i, !1, !0)
                        : "",
                      p = '<span class="vscomp-value-tag" data-index="'
                        .concat(t.index, '" ')
                        .concat(
                          u,
                ...
                if ("" === v) r.innerHTML = this.placeholder;
                  ...
                  if (
                    ...
                    var y = '<span class="vscomp-selected-value-count">'.concat(
                      u,
                      "</span>"
                    );
                    if (
                      (f &&
                        (y += ' / <span class="vscomp-max-value-count">'.concat(
                          f,
                          "</span>"
                        )),
                      h)
                      ...
                      (r.innerHTML = l.join("")),
                        (this.$valueTags =
                          r.querySelectorAll(".vscomp-value-tag")),
              ...
              var m = "";
              0 === u ? (m = this.placeholder) : n || (m = l.join(", ")),
                n || p.setData(r, "tooltip", m),
                t &&
                  (n
                    ? this.updatePosition()
                    : p.setData(r, "tooltipEllipsisOnly", 0 === u));
            },
          },
          {
            key: "setSearchValue",
            value: function (e) {
              ...
              if (e !== this.searchValueOriginal || i) {
                ...
                (this.searchValue = o),
                  ...
                  p.toggleClass(this.$allWrappers, "has-search-value", e),
            ...
            value: function (e) {
              ...
              e
                ...
                : ((t = this.optionsHeight),
                  this.keepAlwaysOpen &&
                    (p.setStyle(this.$noOptions, "height", t),
                    p.setStyle(this.$noSearchResults, "height", t))),
                p.setStyle(this.$optionsContainer, "max-height", t),
          ...
          },
          {
            ...
            value: function () {
              ...
              e && (this.showAsPopup ? (t["max-width"] = e) : (i.width = e)),
                p.setStyles(this.$dropboxContainer, i),
                p.setStyles(this.$dropbox, t);
            },
          },
          {
            key: "setOptionAttr",
            ...
            value: function (e) {
              var t =
                ...
                o = {
                  "data-tooltip":
                    (s.containsHTML(e)
                      ? s.replaceDoubleQuotesWithHTML(e)
                      : e) || "",
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              do {
                ...
                p.hasClass(o, "disabled") ||
                p.hasClass(o, "group-title")
              );
              return o;
            },
          },
          ...
          },
          {
            ...
            value: function (e) {
              (this.isSilentOpen = e),
                e
                  ? p.setStyle(this.$dropboxContainer, "display", "inline-flex")
                  : (p.dispatchEvent(this.$ele, "beforeOpen"),
                    p.setAria(this.$wrapper, "expanded", !0)),
                this.setDropboxWrapperWidth(),
                p.removeClass(this.$allWrappers, "closed"),
                p.changeTabIndex(this.$allWrappers, 0),
            ...
            value: function () {
              ...
              (this.isSilentOpen = !1),
                e ||
                  ...
                  this.setScrollTop(),
                  p.addClass(this.$allWrappers, "focused"),
                  this.showAsPopup
                    ? (p.addClass(this.$body, "vscomp-popup-active"),
                      (this.isPopupActive = !0))
                    : this.focusElementOnOpen(),
                  p.dispatchEvent(this.$ele, "afterOpen"));
            },
          },
          {
            key: "closeDropbox",
            value: function (e) {
              (this.isSilentClose = e),
                this.keepAlwaysOpen
                  ? this.removeOptionFocus()
                  : (e
                      ? p.setStyle(this.$dropboxContainer, "display", "")
                      : (p.dispatchEvent(this.$ele, "beforeClose"),
                        p.setAria(this.$wrapper, "expanded", !1),
                        p.setAria(this.$wrapper, "activedescendant", "")),
                    this.dropboxPopover && !e
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.isSilentClose = !1),
                p.removeClass(this.$allWrappers, "focused"),
                this.removeOptionFocus(),
                !e &&
                  this.isPopupActive &&
                  (p.removeClass(this.$body, "vscomp-popup-active"),
                  (this.isPopupActive = !1)),
                p.addClass(this.$allWrappers, "closed"),
                e ||
                  (p.dispatchEvent(this.$ele, "afterClose"),
                  ((this.initialSelectedValue &&
                    0 === this.initialSelectedValue.length) ||
          ...
          },
          {
            ...
            value: function () {
              var e = this.$optionsContainer.querySelector(
                "[data-index='".concat(this.getFirstVisibleOptionIndex(), "']")
              );
              e
                ? (p.hasClass(e, "group-title") &&
                    (e = this.getSibling(e, "next")),
                  p.setAttr(e, "tabindex", "0"),
                  (this.$optionsContainer.scrollTop =
                    this.optionHeight * this.getFirstVisibleOptionIndex()),
                  this.focusOption({ focusFirst: !0 }),
                  e.focus())
                : (e = this.$dropbox.querySelector('[tabindex="0"]')) &&
                  e.focus();
            },
          },
          {
            ...
            value: function () {
              ...
              if (o) e = o;
                ...
                (e = this.$dropboxContainer.querySelector(
                  ...
                  (p.hasClass(e, "disabled") || p.hasClass(e, "group-title")) &&
                    (e = this.getSibling(e, "next"));
              ...
              e &&
                ...
                this.toggleFocusedProp(p.getData(e, "index"), !0),
              ...
              if (e) {
                ...
                if (
                  ...
                  if (this.multiple)
                    ...
                    o.length &&
                      this.toggleSelectedProp(this.getOptionIndex(o[0]), !1),
                      (o = [n]);
                    var c = this.$dropboxContainer.querySelector(
                      ".vscomp-option.selected"
                    );
                    c && this.toggleOptionSelectedState(c, !1),
                      this.closeDropbox(),
              ...
              if (this.multiple && !this.disableSelectAll) {
                var t =
                    "boolean" == typeof isSelected
                      ? e
                      : !p.hasClass(this.$toggleAllCheckbox, "checked"),
                  i = [],
              ...
              if (this.multiple) {
                ...
                "boolean" == typeof e || (e = this.isAllOptionsSelected()),
                  !e &&
                    ...
                    "" !== this.searchValue &&
                    (this.visibleOptionsCount > 0 || "" === this.searchValue) &&
                    (t = this.isAllOptionsSelected(!0)),
                  p.toggleClass(this.$toggleAllCheckbox, "checked", e || t),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.forEach(function (e) {
                ...
                this.setValue(null, { disableEvent: t, disableValidation: e }),
                this.afterValueSet(),
                e && p.removeClass(this.$allWrappers, "has-error"),
                p.dispatchEvent(this.$ele, "reset");
            },
          },
          {
            key: "addOption",
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                ...
                r || !u || p || (p = u.toLowerCase().includes(i)),
                (t.isVisible = p),
                o || (o = l === i || a === i),
          ...
          },
          {
            key: "serverSearch",
            value: function () {
              p.removeClass(this.$allWrappers, "has-no-search-results"),
                p.addClass(this.$allWrappers, "server-searching"),
          ...
          },
          {
            ...
            value: function () {
              (this.$ele.disabled = !1),
                ...
                p.setAria(this.$wrapper, "disabled", !1),
                p.changeTabIndex(this.$wrapper, 0);
            },
          },
          {
            key: "disable",
            value: function () {
              (this.$ele.disabled = !0),
                ...
                p.setAria(this.$wrapper, "disabled", !0),
                p.changeTabIndex(this.$wrapper, -1),
                this.$wrapper.blur();
            },
          },
          {
            ...
            value: function () {
              ...
              return (
                this.required &&
                  ...
                  (e = !0),
                p.toggleClass(this.$allWrappers, "has-error", e),
                !e
              );
            },
          },
          {
            ...
            value: function () {
              ...
              (e.virtualSelect = void 0),
                ...
                (e.innerHTML = ""),
                this.hasDropboxWrapper &&
                  (this.$dropboxWrapper.remove(), this.removeEvents()),
                this.dropboxPopover && this.dropboxPopover.destroy(),
                p.removeClass(e, "vscomp-ele");
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e, t) {
              var i = t;
              void 0 === i && (i = !p.hasClass(e, "selected")),
                p.toggleClass(e, "selected", i),
                p.setAria(e, "selected", i);
            },
          },
          {
            ...
            value: function (e, t) {
              e &&
                (p.toggleClass(e, "focused", t),
                p.setAttr(e, "tabindex", t ? "0" : "-1"),
                document.activeElement !== this.$searchInput && e.focus(),
                t && p.setAria(this.$wrapper, "activedescendant", e.id));
            },
          },
        ]),
        (o = [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              p.setAttrFromEle(t, n, Object.keys(x), k),
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                ...
                var G = {
                    top: { top: E - p - D, left: k + A },
                    bottom: { top: E + b + D, left: k + A },
                    right: { top: E + T, left: k + y + D },
                    left: { top: E + T, left: k - c - D },
                  },
                  H = G[C];
                if (
                  ((E = H.top),
                ...
                if (
                  ...
                  "top" === C || "bottom" === C
                    ...
                    i.setStyle(
                      ...
                      "transform",
                      "translate3d("
                        .concat(parseInt(W), "px, ")
                        .concat(parseInt(q), "px, 0) ")
                        .concat(K)
                    );
                }
        ...
        (i = [
          ...
          },
          {
            ...
            value: function (t, i, s, n) {
              t &&
                (i = o.removeArrayEmpty(i.split(" "))).forEach(function (i) {
        ...
        return (
          ...
          (i = [
            ...
            },
            {
              ...
              value: function (e) {
                var t = this,
                  ...
                  a = e.throttle;
                s &&
                  (n = o.removeArrayEmpty(n.split(" "))).forEach(function (e) {
            ...
            },
            {
              ...
              value: function () {
                (this.$scrollableElems = u.getScrollableParents(this.$ele)),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                (this.$ele = e.ele),
                  ...
                  (this.zIndex = parseFloat(e.zIndex)),
                  (this.hideOnOuterClick = t(e.hideOnOuterClick)),
                  (this.showOnHover = t(e.showOnHover)),
                  (this.hideArrowIcon = t(e.hideArrowIcon)),
                  (this.disableManualAction = t(e.disableManualAction)),
                  (this.disableUpdatePosition = t(e.disableUpdatePosition)),
            ...
            },
            {
              ...
              value: function () {
                ...
                (t.popComp = this),
                  ...
                  u.addClass(this.$popover, "pop-comp-wrapper");
              },
            },
            {
              ...
              value: function () {
                this.isShown() ||
                  (this.isShownForOtherTrigger()
                    ...
                    : (u.addClass(this.$popover, "pop-comp-disable-events"),
            ...
            },
            {
              ...
              value: function () {
                ...
                this.showOnHover
                  ...
                  : u.removeClass(this.$popover, "pop-comp-disable-events"),
